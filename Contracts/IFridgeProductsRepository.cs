...
namespace Contracts
{
    public interface IFridgeProductsRepository
    {
        ...
        IEnumerable<ProductsInFridgeWithDescriptionDTO> JoinFridgeDescriptionModelsWithProductsInFridge(IEnumerable<FridgeWithModelsDTO> fridgeWithModels,IEnumerable<ProductsInFridgeDTO> productsInFridge);
        ...
        bool FridgeDTOIsEmpty(FridgeDTO fridgeDTO);
    }
}
